...
void Level1Sc1::initActors(Player* player) 
{
	...
	enemies.push_back(EnemyFactory::instance().getEnemy(glm::vec2(38 * tileSize, 18 * tileSize), EnemyFactory::SKELETON1));
	enemies.push_back(EnemyFactory::instance().getEnemy(glm::vec2(64 * tileSize, 18 * tileSize), EnemyFactory::SKELETON1));
	enemies.push_back(EnemyFactory::instance().getEnemy(glm::vec2(96 * tileSize, 18 * tileSize), EnemyFactory::SKELETON1));
	enemies.push_back(EnemyFactory::instance().getEnemy(glm::vec2(128 * tileSize, 18 * tileSize), EnemyFactory::SKELETON1));
	enemies.push_back(EnemyFactory::instance().getEnemy(glm::vec2(160 * tileSize, 18 * tileSize), EnemyFactory::SKELETON1));
