...
public:
	enum SFX
	{
		AXE, CRUCIFIX, DASH, DESTROY_BIG_BLOCK, DESTROY_BLOCK, DESTROY_GLASS, DESTROY_GLASS_HEAVY, ENEMY_ATTACK, ENEMY_BIG_DEATH, SKEL_DEATH_FUNNY, SKEL_DEATH1, ENEMY_SWIPE,
