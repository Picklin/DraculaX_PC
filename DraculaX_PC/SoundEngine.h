...
public:
	enum SFX
	{
		AXE, WYVERN_APPEAR, WYVERN_ATTACK, WYVERN_DEATH, WYVERN_FIRE, WYVERN_ROAR, WYVERN_WINGS, CRUCIFIX, DASH, DESTROY_BIG_BLOCK, DESTROY_BLOCK, DESTROY_GLASS, DESTROY_GLASS_HEAVY, 
		...
		HEAL, HIT_GROUND, HURT_RICHTER, KONAMI_LOGO, ONEUP, OPTION_SELECT, ORB, PAUSE, PICKUP_HEART, PICKUP_HEART_SMALL, PICKUP_TRINKET, START, WHIP
	};
	enum RecurrentSongs
	{
